...
import { Check, X, ArrowRight, ChevronRight, Zap, Star, DollarSign, Shield, Clock, TrendingUp } from "lucide-react";
import { motion } from "motion/react";
import Footer from "@/components/Footer";
export default function DripifyComparisonPage() {
    ...
    <>
          ...
          <div className="bg-zinc-950 py-5 px-6">
            <p className="text-center text-white text-sm font-medium">
              💰 NexusFlow users switch from Dripify and save{" "}
              <span className="text-[#e8836a] font-bold">$600/year on average</span>{" "}
              — without losing a single core feature.
            </p>
          </div>
