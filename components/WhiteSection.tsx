      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            />
            {/*
              Replace this stock photo with an actual NexusFlow product screenshot
              or campaign builder mockup — product screenshots convert significantly
              better for SaaS landing pages.
              alt text updated per SEO recommendations.
            */}
            <img
              src="https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=2670&auto=format&fit=crop"
            ...
            <div
              ...
              style={{ borderColor: '#e5e5e5' }}
            >
              <p className="text-base font-bold" style={{ color: '#10b981', fontFamily: "'Outfit', sans-serif" }}>Account</p>
              <p className="text-base font-bold" style={{ color: '#10b981', fontFamily: "'Outfit', sans-serif" }}>Always Safe</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <h2
              ...
              style={{ color: '#111', fontFamily: "'Outfit', sans-serif" }}
            >
              Your Prospects Won't Know<br />
              It's{' '}
              <span style={{ color: '#e8836a', fontStyle: 'italic' }}>Automated.</span>
              <br />
              <span className="text-3xl md:text-4xl" style={{ color: '#888' }}>And That's Exactly the Point.</span>
            </h2>

            {/* Subheadline — updated */}
            <p className="text-base leading-relaxed mb-8" style={{ color: '#888' }}>
              Most LinkedIn automation tools send the same message to everyone. NexusFlow personalizes every touchpoint using your prospect's name, company, role, and activity — so every message reads like you spent 10 minutes writing it personally.
            </p>

            {/* Bullet points — all 4 updated */}
            <ul className="space-y-4">
              {points.map((item, i) => (
                <li key={i} className="flex items-start gap-3">
                  <div
